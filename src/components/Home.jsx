  ...
  return (
    <div>
      <div className="flex justify-center p-3 gap-5 mt-[2rem]">
        ...
        />
       <button onClick={handleClick}  className="bg-blue-600 p-3 text-white font-semibold border rounded-xl transition-all transform duration-300 hover:bg-blue-900">
      ...
      <div className="relative  ml-[23.6rem] mt-[2rem]">
        ...
        <IoCopyOutline className="absolute top-[25%] left-[70rem] size-5" onClick={() => {
              navigator.clipboard.writeText(content);
              toast.success("Copy to clipboard");
            }}/>
        </div>
      
      <input className="flex justify-center items-center bg-white h-[35px] border border-gray-500 w-[1160px] rounded-sm outline-none " disabled/>
